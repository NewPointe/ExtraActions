...
namespace org.newpointe.ExtraActions
{
    ...
    [WorkflowTextOrAttribute("Url", "Url Attribute", "The Url to redirect to.  <span class='tip tip-lava'></span>", true, "", "", 0, "Url", new string[] { "Rock.Field.Types.TextFieldType", "Rock.Field.Types.UrlLinkFieldType", "Rock.Field.Types.AudioUrlFieldType", "Rock.Field.Types.VideoUrlFieldType" } )]
